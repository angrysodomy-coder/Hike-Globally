...
import { ARTICLE_TITLE, parseMarkdown, renderInline, stripInline } from '../lib/articleMarkdown'

export default function SummerFamilyTreksBlog({ onClose, onBook }) {
  const blocks = useMemo(() => parseMarkdown(sourceMarkdown), [])
  ...
  return (
    <div className="blog-page" ref={pageRef}>
      ...
      <header className="blog-bar">
        ...
        <p className="blog-bar__title">{ARTICLE_TITLE}</p>
      ...
      <section className="blog-hero">
        <div className="blog-hero__media" aria-hidden="true">
          <img src="/images/blog-family-summer-hero.jpg" alt="" />
        </div>
      ...
      <div className="blog-layout">
        ...
        {/* Everything inside <article> comes from the .md file, verbatim. */}
